...
public enum ErrorCode {
   ...
   //lỗi phòng
    NOT_FOUND_ROOM_IN_BRAND(1010,"Not found in the list room",HttpStatus.BAD_REQUEST),
    ...
    NO_SCHEDULES_FOUND(3002,"Không tìm thấy lịch chiếu đang diễn ra ở phòng này",HttpStatus.BAD_REQUEST),
